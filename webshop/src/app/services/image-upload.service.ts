...
const firebaseConfig = {
  ...
  authDomain: 'webshop-01-2022.web.app',
  databaseURL: 'https://webshop-01-2022-default-rtdb.europe-west1.firebasedatabase.app/',
  storageBucket: 'gs://webshop-01-2022.appspot.com/'
};
